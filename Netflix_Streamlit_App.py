...
def main():
    ...
    if 'title' not in movies_df.columns or movies_df['title'].empty:
        st.error("Data film tidak valid. Kolom 'title' tidak ditemukan atau kosong.")
        st.stop()
                    ...
                    for _, row in recommendations.iterrows():
                        with st.container():
                            ...
                            <div class="recommendation-box">
                                <h4>{row['title']} (Similarity: {row['similarity_score']})</h4>
